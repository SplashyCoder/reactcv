  ...
  return (
    <div className="app">
        ...
        <div className="personalProfile">
                ...
                <p className="personalProfileDescription text">I have experience in Full Stack development (Frontend and Backend), specializing in React, React Native, and Node.js. I have experience in designing and implementing web and mobile applications, API integration, databases, and cloud deployments. Additionally, I have experience with agile methodologies, mainly in the role of Scrum Master.</p>
            </div>
        </TextContainer>
        <TextContainer>
            <div className="projects">
                ...
                <div className='passwordStack'>
                    ...
                    <h1 className="subTitle">EXPERIENCE</h1>
                     ...
                     <div className="password">
                        <div className="passwordTitle "><h2 className="subTileH2">Technologies – Full Stack Developer & Scrum Master</h2></div>
                        <div>
