        ...
        <div class="projects">
                ...
                <div class="password">
                    ...
                    <div class="passwordStack">
                        <ul class="techStack">
                            <h4 class="text">Technologies</h4>
                            <li class="passwordItem1 text">JavaScript</li>
                            <li class="passwordItem2 text">HTML 5</li>
                            <li class="passwordItem3 text">CSS 3</li>
                            <li class="passwordItem1 text">React</li>
                            <li class="passwordItem2 text">Python</li>
                            <li class="passwordItem3 text">SQL</li>
                            <li class="passwordItem1 text">Firebase</li>
                            <li class="passwordItem2 text">Docker</li>
                            <li class="passwordItem3 text">Bootstrap</li>
                        </ul>
                    </div>
