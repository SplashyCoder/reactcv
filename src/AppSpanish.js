...
export default function AppSpanish() {
  return (
    <div className="app">
    ...
    <TextContaier className='namesTitle'>
        <div className="namesContainer">
            ...
            <h1 className="title title2">DESAROLLADOR FRONTEND</h1>
        </div>
    </TextContaier>
    ...
    <div className="personalProfile">
            ...
            <p className="personalProfileDescription text">Soy una persona paciente, con buenas habilidades interpersonales y técnicas, además me mantengo en contacto con las herramientas y prácticas de vanguardia del desarrollo. Tengo experiencia en proyectos personales y freelance en roles Frontend y Backend. Realmente trabajo en plataformas Linux, sin embargo,  me desenvuelvo fácilmente en entornos Windows y Mac.</p>
        </div>
    </TextContaier>
    <TextContaier>
